...
class CorrespondentInterbankDeposits extends CorrespondentMainClass {
    ...
    formatQuery(date, where_query = '99991286') {
    ...
    inner_bank_deposits(...args) { /* Межбанковские депозиты (10521, 10531, 10541) */
...
module.exports = CorrespondentInterbankDeposits