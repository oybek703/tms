...
class CorrespondentInterbankDeposits extends CorrespondentMainClass {
	innerBanks: { name: string; code: string }[]
	...
	async agro_bank() {
		/* Agrobank.Uzbekistan */
		return await this.getOneRow('-', 'Agrobank.Uzbekistan', '', this.agroBankQuery, false)
	} /* Agrobank.Uzbekistan */

	liq_assets_total(...args: any) {
