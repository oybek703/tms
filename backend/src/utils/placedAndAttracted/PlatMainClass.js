...
class PlatMainClass extends MainClass {
    ...
    async organization_deposits() { /* в т.ч. счета государственных и бюджетных организаций */
        return await this.getOneRow(
            ...
            '203-205, 20207, 20210',
            `code_coa='20203' or code_coa='20204' or code_coa='20205' or code_coa='20207' or code_coa='20210'`
        )
    } /* в т.ч. счета государственных и бюджетных организаций */
    ...
    async getRows() {
        ...
        const involvedMiddleValue = [...involvedFunds].filter((_, i) => i !== 1).reduce((acc, val) => acc+=val['sum'], 0)
