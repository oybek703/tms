import { createMainIndicatorsData, getMainIndicatorsTotalData,
  returnDiffer } from '../mainIndicators/mi_pure_functions'
...
class ProfitLostMainClass extends MainClass {
  ...
  async getOneRow(count: string, indicatorName: string, role = 'O_O',
      isTableHead = false) {
    ...
    return createMainIndicatorsData(count, indicatorName, YEAR_BEGIN, MONTH_BEGIN,
