...
export function createMainIndicatorsData(
    count: string, indicatorName: string, YEAR_BEGIN: StringOrNumber,
...
export function getMainIndicatorsTotalData(...args: Total[]) {
  let yearBegin = 0; let monthBegin = 0; let selectedDate = 0
  args.forEach((arg) => {
...
export function returnDiffer(
    indicatorName: string, total: Total, left: Total,
