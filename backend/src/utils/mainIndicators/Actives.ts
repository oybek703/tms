import MainIndicatorsMainClass from './mainIndicatorsMainClass'
import { getMainIndicatorsTotalData } from './mi_pure_functions'
...
class Actives extends MainIndicatorsMainClass {
	...
	async loan_portfolio() {
		/* Кредитный портфель */
		return await this.getOneRow('', 'Кредитный портфель', '', this.mainIndicatorsQuery('L_P'), true)
	} /* Кредитный портфель */

	client_credits(...args: any) {
	...
	async fixed_assets() {
		...
		return await this.getOneRow('', 'Основные средства банка', `code_coa like '165%'`, null, true)
	} /* Основные средства банка */
	...
	async other_actives() {
		/* Другие активы */
		return await this.getOneRow('', 'Другие активы', '', this.mainIndicatorsQuery('O_A'), true)
	} /* Другие активы */

	async total_actives() {
		/* Всего активов */
		return await this.getOneRow('', 'Всего активов', '', this.mainIndicatorsQuery('T_A'), true)
	} /* Всего активов */
	...
	async total_liabilities() {
		/* Всего обязательств */
		return await this.getOneRow('', 'Всего обязательств', '', this.mainIndicatorsQuery('T_L'), true)
	} /* Всего обязательств */
	...
	async current_profit() {
		/* Текущая прибыль */
		return await this.getOneRow('', 'Текущая прибыль', '', this.mainIndicatorsQuery('C_P'))
	} /* Текущая прибыль */

	async total_capital() {
		/* Совокупный капитал */
		return await this.getOneRow('', 'Совокупный капитал', '', this.mainIndicatorsQuery('T_C'))
	} /* Совокупный капитал */
