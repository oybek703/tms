...
exports.FilialEffectivenessBase = void 0;
const base_1 = require("../../base");
class FilialEffectivenessBase extends base_1.Base {
    formatQuery() {
        return `WITH CREDIT_PART AS (
						SELECT FILIAL_CODE,
                     ...
                     WHERE OPER_DAY = DATE '${this.date}' GROUP BY FILIAL_CODE),
								 RESOURCE_DEBT AS (SELECT SUBSTR(CLIENT_CODE, 4, 5) AS FILIAL_CODE,
												ROUND(SUM((SELECT /*+index_desc(s UK_SALDO_ACCOUNT_DAY)*/
																	 ...
																	 WHERE CODE_COA = '16102' AND CODE_FILIAL = '00873'
    ...
    async getRows() {
        ...
        return await this.getDataInDates('true', undefined, true);
    }
}
exports.FilialEffectivenessBase = FilialEffectivenessBase;
//# sourceMappingURL=FL.base.js.map