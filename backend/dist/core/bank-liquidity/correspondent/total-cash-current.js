...
exports.TotalCashCurrent = void 0;
const total_cash_1 = require("./total-cash");
const date_fns_1 = require("date-fns");
class TotalCashCurrent extends total_cash_1.TotalCash {
    ...
    async cash_on_road() {
        return await this.getOneRow('1.2', 'Денежная наличность в обменных пунктах, банкоматах и деньги в пути', `CODE_COA IN ('10103', '10107', '10111', '10109')`);
    }
    async nostro() {
    ...
    async corr_accounts_with_other_banks() {
        const data = await this.getDataInDates('', this.corrAccountsWithOtherBanksQuery, true);
        return data.map(b => (Object.assign(Object.assign({}, b), { count: '-', indicatorName: b['name'] })));
    }
    async getRows() {
        const [totalCashOnHand, cashOnRoad, nostro, F_O_R, corrAccountsWithOtherBanks] = await Promise.all([
...
exports.TotalCashCurrent = TotalCashCurrent;
//# sourceMappingURL=total-cash-current.js.map