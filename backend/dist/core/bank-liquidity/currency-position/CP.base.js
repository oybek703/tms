...
exports.CurrencyPositionBase = void 0;
const base_1 = require("../../base");
class CurrencyPositionBase extends base_1.Base {
    constructor() {
        super(...arguments);
        this.currencyCodes = [
    ...
    async getOneRow(currencyCode1, isTableHead = false) {
        const { currencyCode = currencyCode1, currencyName = 'no_data', rcc = 0, requirements = 0, contingencyClaims = 0, lcl = 0, liabilities = 0, contingencyLiabilities = 0, zero8 = 0, openCurRate = 0, forCurrRate = 0, longVal = 0, shortVal = 0, posRatio = '0' } = await this.getDataInDates(currencyCode1, undefined);
        return {
            currencyCode,
            contingencyClaims,
    ...
    async getRows() {
        const allRows = (await Promise.all(this.currencyCodes.map(({ code, isHead }) => this.getOneRow(code, isHead)))).map(currency => {
...
exports.CurrencyPositionBase = CurrencyPositionBase;
//# sourceMappingURL=CP.base.js.map