...
exports.NostroMatrixBase = void 0;
const base_1 = require("../../base");
class NostroMatrixBase extends base_1.Base {
    constructor(firstDate, secondDate, oracleService) {
    ...
    async getRows() {
        return await Promise.all(this.currencyCodes.map(async ({ code, title }) => {
            const currencyRowsData = await this.getDataInDates(code, undefined, true);
            return { code, title, data: currencyRowsData };
        }));
    }
}
exports.NostroMatrixBase = NostroMatrixBase;
//# sourceMappingURL=nostro-matrix.base.js.map