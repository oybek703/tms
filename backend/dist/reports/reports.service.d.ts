...
export declare class ReportsService {
    ...
    constructor(oracleService: OracleService, configService: ConfigService, httpService: HttpService);
    operDays(): Promise<{
        dates: Date[];
    }>;
    ...
    nostroMatrix(firstDate: Date, secondDate: Date): Promise<{
        code: string;
        title: string;
    ...
    gapManual(forEditing: boolean | string): Promise<{
        months: any;
        sourceOfLiquidity: any;
        sourceOfLiquidityTotal: any;
        needsOfLiquidity: any;
    ...
    updateGapManual({ date, role, newValue, source, colName }: UpdateGapDto): Promise<{
        success: boolean;
        message: string;
    }>;
    ...
    dashboardMonthly(firstDate: Date, secondDate: Date): Promise<{
        capital: ({
            count: string;
            indicatorName: string;
            data: any[];
