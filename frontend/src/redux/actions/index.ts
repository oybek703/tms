import { ADDUSER_FAIL, ADDUSER_REFRESH, ADDUSER_START, ADDUSER_SUCCESS, BANKLIMITS_FAIL, BANKLIMITS_START, BANKLIMITS_SUCCESS, CHANGE_DATE, CORRESPONDENT_CURRENT_FAIL, CORRESPONDENT_CURRENT_START, CORRESPONDENT_CURRENT_SUCCESS, CORRESPONDENT_CURRENT_UPDATE, DASHBOARD_ACTIVE_TAB_CHANGE, DASHBOARDMONTHLY_FAIL, DASHBOARDMONTHLY_START, DASHBOARDMONTHLY_SUCCESS, DELETE_USER, GAP_FAIL, GAP_START, GAP_SUCCESS, GAPMANUAL_FAIL, GAPMANUAL_START, GAPMANUAL_SUCCESS, LAST_UPDATE_FAIL, LAST_UPDATE_START, LAST_UPDATE_SUCCESS, LIQUIDITY_CURRENT_FAIL, LIQUIDITY_CURRENT_START, LIQUIDITY_CURRENT_SUCCESS, LIQUIDITY_CURRENT_UPDATE, LOGIN_FAIL, LOGIN_START, LOGIN_SUCCESS, LOGOUT, OPERATIONAL_DAYS_FAIL, OPERATIONAL_DAYS_START, OPERATIONAL_DAYS_SUCCESS, UPDATE_CBN, USER_EXITED, USERS_FAIL, USERS_START, USERS_SUCCESS } from './types'
