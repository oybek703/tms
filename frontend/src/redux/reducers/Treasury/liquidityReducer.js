...
function liquidity(state = initialState, action) {
...
export function liquidityCurrentState(state = false, action) {
    const {type, payload} = action
    switch (type) {
...
export function liquidityCurrent(state = initialState, action) {
    const {type, payload} = action
    switch (type) {
