...
function correspondent(state = initialState, action) {
...
export function correspondentCurrentState(state = false, action) {
    const {type, payload} = action
    switch (type) {
...
export function correspondentCurrent(state = initialState, action) {
    const {type, payload} = action
    switch (type) {
