    ...
    <Fragment>
      ...
      <Grid sx={{ margin: '20px 0', maxWidth: '40%' }}>
        <Table size='small'>
          <TableHead className={classes.stickyTableHead}>
            <TableRow>
              <TableCell align='left'><BoldWithColor><i>Для довостребовние (70% кор.счет)</i></BoldWithColor></TableCell>
              <TableCell align='right'><BoldWithColor><i>{formatNumber(forFOR)}</i></BoldWithColor></TableCell>
            </TableRow>
            <TableRow>
              <TableCell align='left'><BoldWithColor><i>Для ФОР</i></BoldWithColor></TableCell>
              <TableCell align='right'><BoldWithColor><i>{formatNumber(forDemandDeposits)}</i></BoldWithColor></TableCell>
            </TableRow>
          </TableHead>
        </Table>
      </Grid>
