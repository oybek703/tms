      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="body2">
                      Для обновления норматив центрального банка введите число
                      полученное от центрального банка разделив на 1000,
                      &nbsp;
            <b>например:</b> если норматив центрального банка равен
                      883522858640.53,
        ...
        <form onSubmit={handleDialogClose}>
            ...
            <Grid container spacing={3} justifyContent='space-between'
              ...
              <Grid item>
                <TextField
                  ...
                  label="From"
                  value={fromDate}
                  onChange={({ target: { value } }) => setFromDate(
                      value)}
                  type="date"
                  InputLabelProps={{
                    shrink: true
              ...
              <Grid item>
                <TextField
                  ...
                  label="To"
                  value={toDate}
                  onChange={({ target: { value } }) => setToDate(
                      value)}
                  type="date"
                  InputLabelProps={{
                    shrink: true
          ...
          <DialogActions>
            <Button variant='outlined'
              onClick={() => setDialog(false)} color="primary">
                          Cancel
            </Button>
