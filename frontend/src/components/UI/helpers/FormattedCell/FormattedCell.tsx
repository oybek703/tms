...
const FormattedCell: React.FC<FormattedCellProps> = ({
	...
	return (
		<Grid className={classes.noWrap} container component="span" alignItems="center" justifyContent={alignText}>
			{number < 0 ? (
			...
			{
				<Typography variant={`${textVar}`} component="b" className={number < 0 ? classes.down : classes.grow}>
