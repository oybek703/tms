						...
						<Grid item>
							<Grid container alignItems="center" alignContent="center" component="span">
										...
										{pathname === '/correspondent' ? (
											<>
												<FormControlLabel
													...
													label={<span style={{ color: '#333' }}>Текущие состояние</span>}
												/>{' '}
								...
								<Tab
									...
									component="span"
									label={
										<Button variant="contained" onClick={handleClick} className={classes.noWrap}>
			...
			>
				{({ TransitionProps }) => (
					<Grow {...TransitionProps} style={{ transformOrigin: 'center top' }}>
						<Paper variant="elevation" elevation={2} classes={{ root: classes.menu }} onMouseLeave={handleClose}>
							<ClickAwayListener onClickAway={handleClose}>
								...
								>
									...
									<MenuItem classes={{ root: classes.menuItem }} onClick={handleExit}>
										Exit
									</MenuItem>
								</MenuList>
							</ClickAwayListener>
