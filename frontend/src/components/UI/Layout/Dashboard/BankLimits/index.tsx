	...
	return (
		<TableHead sx={globalStyles.stickyTableHead}>
			<TableRow>
				...
				<TableCell align="center">
					<BoldWithColor>Остаток корр. счетов</BoldWithColor>
				</TableCell>
				<TableCell align="center">
					<BoldWithColor>Лимит - 22%</BoldWithColor>
				</TableCell>
				<TableCell align="center">
					<BoldWithColor>Разница</BoldWithColor>
				</TableCell>
				<TableCell align="center">
					<BoldWithColor>(%) лимита</BoldWithColor>
				</TableCell>
				<TableCell align="center">
					<BoldWithColor>Лимит - 24%</BoldWithColor>
				</TableCell>
			</TableRow>
		</TableHead>
	)
														...
														innerData={
															<Table>
																<TableHead>
																	<TableRow>
																		<TableCell>
																			<b>Процент лимита - 22%</b>
																		</TableCell>
																		<TableCell>
																			<b>Процент лимита - 24%</b>
																		</TableCell>
																	</TableRow>
																</TableHead>
																<TableBody>
																	<TableRow>
																		<NoWrapCell
																			celldata={<ProgressOrText showNumber celldata={row['limitPercent22']} />}
																		/>
																		<NoWrapCell
																			celldata={<ProgressOrText showNumber celldata={row['limitPercent24']} />}
																		/>
																	</TableRow>
																</TableBody>
															</Table>
...
const BankLimits: React.FC<BankLimitsProps> = ({ bankLimits }) => {
	...
	return (
		<Fragment>
			...
			{expanded === 'local' ? <BanksTable rows={localBanks} /> : <BanksTable rows={foreignBanks} />}
		</Fragment>
	)
}
