...
const DailyIndicators: React.FC<DailyIndicatorsProps> = ({dashboardCorrespondent = [], dashboardCurrencyPosition = {},
  vla = {}, lcr = {}, nsfr = {}}) => {
  ...
  return (
      <Fragment>
        ...
        <FakeSuspense>
          <Grid container
                justifyContent='space-between' className={classes.smallCardContainer}>
