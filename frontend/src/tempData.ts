...
export const covenantData = [
  {
    ...
    bank_7: getMinBankData(14.24, 13),
    bank_8: getMinBankData(14.24, 14),
    bank_9: getMinBankData(14.24, 13)
  },
  {
    ...
    bank_7: getMinBankData(13.03, 10),
  ...
  },
  {
    ...
    bank_2: getEmptyBankData(),
    bank_3: getEmptyBankData(),
    bank_4: getMaxBankData(68.59, 75),
    bank_5: getEmptyBankData(),
    bank_6: getEmptyBankData(),
    bank_7: getEmptyBankData(),
    bank_8: getEmptyBankData(),
  ...
  },
  {
    ...
    bank_6: getEmptyBankData(),
    bank_7: getEmptyBankData(),
    bank_8: getMaxBankData(12.72, 20),
    bank_9: getEmptyBankData()
  },
  {
  ...
  получено письмо об
   изменении требования до 26% до 31.12.2022г).`,
    ...
    bank_6: getEmptyBankData(),
    bank_7: getEmptyBankData(),
    bank_8: getMaxBankData(19.14, 20),
    bank_9: getEmptyBankData()
  },
  {
    ...
    bank_6: getEmptyBankData(),
    bank_7: getEmptyBankData(),
    bank_8: getMaxBankData(376.41, 800),
    bank_9: getEmptyBankData()
  },
  {
  ...
  получено письмо об изменении требования до 55% до 31.12.2021г).`,
    ...
    bank_6: getEmptyBankData(),
    bank_7: getEmptyBankData(),
    bank_8: getMaxBankData(50.24, 55),
    bank_9: getEmptyBankData()
  },
  {
    ...
    bank_2: getEmptyBankData(),
    bank_3: getEmptyBankData(),
    bank_4: getPureBankData('больше чем 0', Status.safe),
    bank_5: getEmptyBankData(),
    bank_6: getEmptyBankData(),
    bank_7: getEmptyBankData(),
    bank_8: getEmptyBankData(),
