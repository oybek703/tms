export const covenantData = [
  ...
  Регулятивный капитал (согласно контракту 20% при этом, получено письмо об
  ...
  (согласно контракту 20% при этом, получено письмо об изменении требования до 55% до 31.12.2021г).`,
